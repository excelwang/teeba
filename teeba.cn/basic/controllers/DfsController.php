...
use Yii;
use app\models\Dfs;
use app\models\DfsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DfsController implements the CRUD actions for Dfs model.
 */
class DfsController extends Controller
{
    ...
    /**
     * Lists all Dfs models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DfsSearch();
